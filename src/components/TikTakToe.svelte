...
<div class="w-96 flex flex-col gap-2 items-center">
	<div
		class={'border-2 border-black w-52 rounded-lg p-2 px-3 font-bold flex justify-center text-sm' +
			' ' +
			messageColor[statusId]}
	>
	...
	<button
		on:click={init}
		class="text-sm transition-colors duration-100 hover:bg-gray-200 border-2 font-bold rounded-lg p-2 border-black"
		>RESTART</button
	>
</div>
